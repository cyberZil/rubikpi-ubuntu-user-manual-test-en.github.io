...
**1: Before launching the Qdemo, ensure the target device meets all the following prerequisites**  
...
**3. Create media, labels, models and data folder and change owner to ubuntu:ubuntu.**   
```shell
