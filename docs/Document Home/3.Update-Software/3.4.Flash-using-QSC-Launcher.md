...
# Flash Canonical Ubuntu 24.04
	...
	1. In the Launcher, select the **Development Kit** as RubikPi and the **Target Operating System** as Ubuntu.  
	...
	3. Click Flash to begin updating the Renesas USB firmware.    
	...
	5. After successful flashing, the following confirmation screen will appear.  
	:::note
	...
	### 3️⃣ Setup
	1. After the OS image flashing is complete, the launcher will reboot your Rubik Pi 3 device into the newly installed operating system. You can now proceed to configure the device.
